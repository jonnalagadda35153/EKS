...
try:
    ...
    print("Please copy the role name, the same will be used in deployment automation")
...
#Updating AWS EKS Auth with the new role and attaching it to the user account.
